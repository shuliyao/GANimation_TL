...
#训练数据:EmotionNet或celebA（celebA的训练图像和au信息可以在https://github.com/albertpumarola/GANimation下的datasets获得）
...
def train():
    ...
    out = discriminator(interpolates, reuse=True)
    ...
    g_sum = tf.summary.merge(
        [loss_g_sum, loss_g_fake_img_masked_sum, loss_g_fake_au_sum, loss_g_cyc_sum, loss_g_mask_fake_sum,
         loss_g_mask_cyc_sum,
         real_img_sum,
